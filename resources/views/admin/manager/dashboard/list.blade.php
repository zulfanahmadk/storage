                    ...
                    <div class="card border-start border-4 border-primary shadow-sm mb-4">
                        <div class="card-body">
                                    ...
                                    <div class="list-group-item list-group-item-action d-flex justify-content-between align-items-center"
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">
                                                Diajukan {{ \Carbon\Carbon::parse($invoice->created_at)->diffForHumans() }}
                                            </small>
                                        </div>
                            ...
                            <div class="mt-3 text-end">
                                <a href="{{ url('manager/invoice') }}" class="btn btn-outline-primary btn-sm">
                                    <i class="bi bi-eye me-1"></i> Lihat Semua Invoice
                                </a>
                            </div>
                        </div>
                    </div>
